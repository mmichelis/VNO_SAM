...
for ep in range(epochs):
    ...
    for x, y in train_loader:
        ...
        optimizer.step()
        # t_train2 = default_timer()

        # train_mse += mse.item()
        # train_l2 += l2.item()

        # t_train3 = default_timer()
        # print(f'load, zero grad, infer: {t_train2-t_train1}, loss, backprop, step: {t_train3-t_train2}')
    t12 = default_timer()
