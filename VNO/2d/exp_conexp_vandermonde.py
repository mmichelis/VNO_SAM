...
TRAIN_PATH = '../../VNO_data/exp_conexp_ns_V1e-3_N5000_T50.mat'
TEST_PATH = '../../VNO_data/exp_conexp_ns_V1e-3_N5000_T50.mat'
...
path = 'exp_conexp_ns_fourier_2d_rnn_V10000_T20_N'+str(ntrain)+'_ep' + str(epochs) + '_m' + str(modes) + '_w' + str(width)
