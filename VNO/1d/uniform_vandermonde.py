...
@author: Levi Lingsch
to implement the 1D VNO on the time independent Burgers equation using data with a uniformly random distribution.
"""
...
prediction_history = open('./training_history/uniform_test_loss.txt', 'w')
