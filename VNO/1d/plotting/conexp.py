...
dataloader = MatReader('../../../nu_data/conexp_burgers_data_R10.mat')
...
ex = 1
predloader = MatReader('../VNO_predictions/conexp_burger_test.mat')
...
fig.suptitle('VNO Performance on a Contracting-Expanding Distribution', fontsize=20)
